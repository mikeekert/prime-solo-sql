...
UPDATE syntax_practice SET account_balance=10 WHERE transactions_completed = 0;
...
VALUES ('mike', 'bloomingtom', 10, 10, 1000000)
...
DELETE from syntax_practice WHERE city = 'Miami' OR 'Phoenix' AND transactions_completed < 5
